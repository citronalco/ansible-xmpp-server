VirtualHost "bingo-ev.de"

authentication = "imap"

name = "bingo-ev.de Messenger Service";
...
conversejs_options = {
	...
	auto_register_muc_nickname = "true"; -- automatically registers user's nickname in MUC (default: false)
	muc_domain = "conference.bingo-ev.de";  -- default domain for new MUCs (default: unset -> users have to type in MUC domain)
}
conversejs_tags = {
...
Component "conference.bingo-ev.de" "muc"
...
Component "pubsub.bingo-ev.de" "pubsub"
...
Component "upload.bingo-ev.de" "http_upload_external"
	http_upload_external_base_url = "https://upload.bingo-ev.de/share_v2.php/" -- URL to share_v2.php script
	http_upload_external_secret = "SHAREPHPPASSWORDBINGO" -- shared secret, must also be entered in share_v2.php
