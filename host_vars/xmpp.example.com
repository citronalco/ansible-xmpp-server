  ...
  xmpp_domains:
    - name: "foobar.org"
      ...
      conversejs:
        ...
        weblocation: /conversejs-foobar         # offer Converse.js for foobar.org in https://xmpp.example.com/conversejs-foobar (optional, default: /<xmpp_domain.name>/conversejs)
